...
The saliency maps are generated from the Cornell Dataset.
...
class IntegratedGradients():
    ...
    def generate_gradients(self, input_image, target_class):
        ...
        # Take "cos" output as angle prediction
        model_angle = model_output[1]
        # Zero grads
        self.model.zero_grad()
        # Target for backprop
        one_hot_output = torch.FloatTensor(1, model_output.size()[-1]).zero_()
        # ==================
        one_hot_output[0][target_class] = 1 # Change this to the GROUND TRUTH angle.
        # ==================
        # Backward pass
...
if __name__ == '__main__':
    ...
    from models import ExtractOutputModel
    ...
    for img, img_id in dataLoader.load_rgbd():
        ...
        ext_model = ExtractOutputModel(model, 'cos', device=params.DEVICE)
        # Integrated backprop
